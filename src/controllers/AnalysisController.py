...
T_SETS = ROOT / "data_test" / "processed"
TARGETS = ROOT / "data_test" / "processed" / "validation_sets" / "plankton"
# Save
ANALYSIS_SAVE = Save.check_dir_exists(f"{ROOT}/results_test/analysis_output")
