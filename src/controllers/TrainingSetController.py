...
with alive_bar(2) as bar:
    try:
        ...
        print(
            " \n ERROR: Problem retrieving sampled ecosystem and ocean physics data..."
        )
        sys.exit(1)
...
with alive_bar(5) as bar:
    try:
        predictors = TSB.return_predictor_dataset(
        ...
        print(
            " \n ERROR: Problem building predictor variable training sets (standard)..."
        )
        sys.exit(1)
...
with alive_bar(4) as bar:
    try:
        ...
        print(" \n ERROR: Problem building predictor variable training sets (large)...")
        sys.exit(1)
...
with alive_bar(2) as bar:
    try:
        ...
        print(" \n ERROR: Problem building plankton training sets...")
        sys.exit(1)
...
with alive_bar(2) as bar:
    try:
        ...
        print(" \n ERROR: Problem building plankton training sets (large)...")
        sys.exit(1)
...
with alive_bar(3) as bar:
    try:
        ...
        cocco_oce, cocco_oce_f = TSB.group_oce_plank(
            eco_oce, eco_oce_f, *np.arange(25, 30)
        )
        diazo_oce, diazo_oce_f = TSB.group_oce_plank(
            eco_oce, eco_oce_f, *np.arange(30, 35)
        )
        diatom_oce, diatom_oce_f = TSB.group_oce_plank(
            eco_oce, eco_oce_f, *np.arange(35, 46)
        )
        dino_oce, dino_oce_f = TSB.group_oce_plank(
            eco_oce, eco_oce_f, *np.arange(46, 56)
        )
        ...
        print(" \n ERROR: Problem building plankton whole-ocean validation sets...")
        sys.exit(1)
...
with alive_bar(2) as bar:
    try:
        ...
        print(" \n ERROR: Problem building predictor whole-ocean validation sets...")
        sys.exit(1)
