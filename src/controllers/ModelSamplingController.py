...
with alive_bar(3) as bar:
    try:
        ...
        print(" \n ERROR: Problem retrieving sampling matrices and ecosys data...")
        sys.exit(1)
...
with alive_bar(2) as bar:
    try:
        ...
        print(" \n ERROR: Problem merging sampling matrices with ecosystem data...")
        sys.exit(1)
...
with alive_bar(2) as bar:
    try:
        ...
        print(" \n ERROR: Problem removing data over land...")
        sys.exit(1)
...
with alive_bar(2) as bar:
    try:
        ...
        print(" \n ERROR: Problem making random sample equal size to obvs sample...")
        sys.exit(1)
